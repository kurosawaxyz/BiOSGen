...
if __name__ == "__main__":
    ...
    optimizer = optim.AdamW([p for p in model.parameters() if p.requires_grad], 
                            ...
                            weight_decay=cfg.optimizer.weight_decay)  # Add weight decay to prevent overfitting
    ...
    lambda_ca = cfg.losses.lambda_ca
    gradient_clip_val = cfg.gradient_clip_val  # More aggressive gradient clipping
