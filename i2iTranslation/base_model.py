...
class BaseModel(ABC):
    ...
    def __init__(self, args):
        ...
        Parameters:
            args (argparse.ArgumentParser):  A list of arguments
        When creating your custom class, you need to implement your own initialization.
        In this function, you should first call <BaseModel.__init__(self, args)>
        ...
        self.save_dir = args.i2i_checkpoint_path
